...
2. Change Host, Port UserName, Password as same as configured by Extended Storage Server.
3. If want to send a different file to Extended Storage Server, please change VideoFilePath and SendTimesPerMinute.
